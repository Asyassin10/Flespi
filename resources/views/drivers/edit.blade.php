...
@section('title', 'Edit Driver - Flespi Fleet Management')
...
<div class="max-w-2xl mx-auto">
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold text-gray-900">Edit Driver: {{ $driver->name }}</h1>
    </div>
        ...
        <form action="{{ route('drivers.update', $driver) }}" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="rfid_card" id="rfid_card" value="{{ old('rfid_card', $driver->rfid_card) }}"
    ...
    <!-- Danger Zone -->
    <div class="mt-6 bg-white rounded-lg shadow p-6 border-2 border-red-200">
        <h2 class="text-lg font-semibold text-red-600 mb-4">Danger Zone</h2>
        <div class="flex items-center justify-between">
            <div>
                <p class="text-sm font-medium text-gray-900">Delete this driver</p>
                <p class="text-sm text-gray-500">Once deleted, the driver data will be permanently removed.</p>
            </div>
            <form action="{{ route('drivers.destroy', $driver) }}" method="POST"
                onsubmit="return confirm('Are you sure you want to delete this driver? This action cannot be undone.');">
                @csrf
                @method('DELETE')
                <button type="submit"
